...
{
    /// <summary>
    /// A variant of the AttackDefault effect with additional effect delegates that can be triggered by DoAdditionalEffect
    /// </summary>
    [CreateAssetMenu(menuName = "Ability Designer/Combat Effects/Attack Effect Variant")]
    public class AttackDelegateVariant : AttackDefault
    {
