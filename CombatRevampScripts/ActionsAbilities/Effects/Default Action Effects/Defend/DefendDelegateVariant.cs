...
{
    /// <summary>
    /// A variant of the DefendDefault effect with additional effect delegates that can be triggered by DoAdditionalEffect
    /// </summary>
    [CreateAssetMenu(menuName = "Ability Designer/Combat Effects/Defend Effect Variant")]
    public class DefendDelegateVariant : DefendDefault
    {
